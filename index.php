...
<body>
    <h1 align='center' style="margin: 15px; color:seagreen;font-weight: bold;font-family:'Times New Roman', Times, serif">JAYPEE COURIER SERVICE</h1>
    <hr />
    ...
    <div class="container" style="margin-top: 60px; width:50%;">
        <div class="row">
            <div class="col-md-12">
                ...
                <p style="color:#e84118;">Please Fill Your Login Details</p>
                <!-- <?php echo $error; ?> -->
